...
BeginTestSection["verify_4pt.mt"]
...
GenSpinors[Range@$multiplicity,FourD->Range@$multiplicity,Seed->1328135534,ParameterRange->50,
  Parametric->False,DisplaySpinors->False];


KillMasses[{q,$bubbleReference}];
GenSpinors[{q,$bubbleReference},FourD->{q,$bubbleReference},RandomSpinors->True,Seed->24092444,ParameterRange->50];
...
VerificationTest[(* 1 *)
  configurations = Configurations[{1,2,3,4},{},{}];
